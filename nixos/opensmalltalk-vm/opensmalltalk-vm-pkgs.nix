{ stdenv, lib, fetchFromGitHub, fetchurl, alsa-lib, coreutils, file, freetype
, gnugrep, libpulseaudio, libtool, libuuid, openssl, pango, pkg-config, xorg
, libGL }:
let
  buildVM = {
    ...
    in stdenv.mkDerivation {
      pname = let vmNameNoDots = builtins.replaceStrings [ "." ] [ "-" ] vmName;
...
in vmsByPlatform.${platform} or (throw
